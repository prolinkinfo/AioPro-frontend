...
const EdiPresentation = (props) => {
    ...
    const initialValues = {
        ...
        assigedType: presentationData?.assigedType,
        assigedTo: presentationData?.assigedTo,
        division: presentationData?.division,
    ...
    const editPresentation = async (values) => {
        ...
        const result = await apiput('/api/presentation', pyload);
...
export default EdiPresentation;
