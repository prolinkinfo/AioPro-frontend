...
const EditHospitalClass = (props) => {
    ...
    const { isOpenEdit, handleCloseEdit, fetchHospitalClassData, data } = props;
    ...
    // -----------   initialValues
    const initialValues = {
        hospitalClass: data?.hospitalClass,
    };
    ...
    const editCategory = async (values) => {
        ...
        const result = await apiput('/api/hospitalclass', pyload);
    ...
    return (
        <div>
            <Dialog open={isOpenEdit} aria-labelledby="scroll-dialog-title" aria-describedby="scroll-dialog-description">
                ...
                >
                    <Typography variant="h6">Edit Hospital Class</Typography>
                    <Typography>
