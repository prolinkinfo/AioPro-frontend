...
import { Autocomplete, Box, Button, Container, Grid, Paper, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TextField, Typography } from '@mui/material'
...
const ZoneManagement = () => {
    ...
    const handleSave = async (id) => {
        ...
        const result = await apiput('/api/citymaster/zoneMap', payload);
    ...
    const fetchCity = (staten) => {
        const filteredCity = cityData?.filter(({ stateName }) => stateName?.toLowerCase() === staten?.toLowerCase());
                        ...
                        <Stack direction={"row"} spacing={2}>
                            <Autocomplete
                                ...
                                onChange={(event, newValue) => {
                                    fetchState(newValue ? newValue.countryName : "");
                                }}
                                options={countryList}
                            ...
                            <Autocomplete
                                size="small"
                                onChange={(event, newValue) => {
                                    fetchCity(newValue ? newValue.stateName : "");
                                }}
                                options={stateList}
                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell align="center">UPDATE ZONE</TableCell>
