...
const AddSkippedReason = (props) => {
    // eslint-disable-next-line react/prop-types
    const { isOpenAdd, handleCloseAdd,fetchSkippedReasonData } = props;
    ...
    const addReason= async (values) => {
        ...
        const result = await apipost('/api/skippedreason', pyload);
...
export default AddSkippedReason;
