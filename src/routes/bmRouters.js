...
export default function BmRouters() {
  const bmRoutes = useRoutes([
    {
      path: `/bm/dashboard`,
      element: <DashboardLayout />,
      children: [
        { element: <Navigate to={`/bm/dashboard/app`} />, index: true },
        ...
        { path: '*', element: <Navigate to={`/bm/dashboard/app`} />, index: true },
