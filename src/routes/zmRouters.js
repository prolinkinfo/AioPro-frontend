...
export default function ZmRouters() {
  const zmRoutes = useRoutes([
    {
      path: `/zm/dashboard`,
      element: <DashboardLayout />,
      children: [
        { element: <Navigate to={`/zm/dashboard/app`} />, index: true },
        ...
        { path: '*', element: <Navigate to={`/zm/dashboard/app`} />, index: true },
