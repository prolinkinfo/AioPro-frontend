...
export default function TmRouters() {
  const tmRoutes = useRoutes([
    {
      path: `/tm/dashboard`,
      element: <DashboardLayout />,
      children: [
        { element: <Navigate to={`/tm/dashboard/app`} />, index: true },
        ...
        { path: '*', element: <Navigate to={`/tm/dashboard/app`} />, index: true },
